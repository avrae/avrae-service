...
class Sourced(abc.ABC):
    ...
    def to_minimal_dict(self):
        return {
            ...
            "entity_type": self.entity_type, "entity_id": self.entity_id, "type_id": self.type_id,
            "entitlement_entity_type": self.entitlement_entity_type,
            "entitlement_entity_id": self.entitlement_entity_id,
